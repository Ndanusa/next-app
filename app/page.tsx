      ...
      <div className={`container mx-auto px-4 py-16`}>
        <div className={`text-center`}>
          ...
          <div className={`flex gap-4 justify-center`}>
              <Link href={`/sign-in`} className={`bg-purple-600 text-white px-8 py-3 rounded-4xl font-semibold hover:bg-purple-700 transition-colors`} style={{cornerShape: "superellipse(2)"}}>Sign In</Link>
