         ...
         <div className={`container mx-auto px-4 py-16`}>
            <div className={`text-center`}>
               ...
               <div className={`flex gap-4 justify-center`}>
                  <Link
                     href={`/sign-in`}
                     className={`bg-purple-600 text-white px-8 py-3 rounded-3xl font-semibold hover:bg-purple-700 transition-colors`}
                     style={{ cornerShape: "superellipse(2)" }}>
                     Sign In
                  </Link>
                  <Link
                     href={`#`}
                     className={`bg-white text-purple-600 px-8 py-3 rounded-3xl font-semibold border-2 border-purple-600 hover:bg-purple-600 hover:text-white transition-all`}
                     style={{ cornerShape: "superellipse(2)" }}>
                     Learn More
                  </Link>
               </div>
